...
namespace SIL.VarGenServiceTest
{
	...
	class VariantCreatorTests : MemoryOnlyBackendProviderTestBase //FwTestBase
	{
		...
		public void AddVariantToEntryTest()
		{
			...
			{
				ILexEntry mainEntry = Cache.ServiceLocator.GetInstance<ILexEntryFactory>().Create();
				IMoStemAllomorph form = mainEntry.Services.GetInstance<IMoStemAllomorphFactory>().Create();
